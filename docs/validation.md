...
`metafor` or `meta` interfaces. Ordinary Python tests read the committed
artifacts and do not require R.
...
Install R plus `metafor`, `meta`, and `jsonlite`, then run from the repository
root:
